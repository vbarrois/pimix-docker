...
docker run -d --name Deemix -v /home/music:/downloads -e PUID=1000 -e PGID=1000 -e ARL=1234567 -e UMASK_SET=022 -e DEEZUI=false -p 83:6595 registry.gitlab.com/bockiii/deemix-docker
